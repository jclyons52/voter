...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryPollAll = (
    ...
    this.request<VoterQueryAllPollResponse, RpcStatus>({
      path: `/jclyons52/voter/voter/poll`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryPoll = (id: string, params: RequestParams = {}) =>
    this.request<VoterQueryGetPollResponse, RpcStatus>({
      path: `/jclyons52/voter/voter/poll/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryVoteAll = (
    ...
    this.request<VoterQueryAllVoteResponse, RpcStatus>({
      path: `/jclyons52/voter/voter/vote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryVote = (id: string, params: RequestParams = {}) =>
    this.request<VoterQueryGetVoteResponse, RpcStatus>({
      path: `/jclyons52/voter/voter/vote/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
