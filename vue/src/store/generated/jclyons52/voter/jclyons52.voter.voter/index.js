...
export default {
    ...
    actions: {
        init({ dispatch, rootGetters }) {
            console.log('Vuex module: jclyons52.voter.voter initialized!');
        ...
        async QueryVoteAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryVoteAll({ ...query, 'pagination.key': value.pagination.nextKey })).data;
